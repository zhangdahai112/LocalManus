...
## 更新摘要
**变更内容**
- 更新了IP地址迁移相关的配置说明，从192.168.96.135迁移到192.168.126.132
- 增强了沙箱配置管理的详细说明
...
**更新** 系统现已支持新的 agent-infra/sandbox 架构，提供 LOCAL 和 ONLINE 两种沙箱执行模式，并完成了IP地址迁移至 192.168.126.132。
...
| SANDBOX_LOCAL_URL | "http://192.168.126.132:8080" | 本地沙箱URL | SANDBOX_LOCAL_URL |
...
SHAREDSBX --> URL1[http://192.168.126.132:8080]
...
- **LOCAL 模式**: 连接到位于 `http://192.168.126.132:8080` 的共享沙箱
...
| **SANDBOX_LOCAL_URL** | **"http://192.168.126.132:8080"** | **本地沙箱地址** |
...
SHAREDSBX --> URL[http://192.168.126.132:8080]
LOCAL --> INSTANT[即时访问]
LOCAL --> SHARED[共享资源]
DEV --> DEBUG[调试模式]
DEBUG --> LOGLEVEL[INFO]
...
**症状**：LOCAL 模式无法连接到沙箱
**解决方案**：
1. 检查沙箱服务是否在 `http://192.168.126.132:8080` 运行
2. 验证网络连通性和防火墙设置
...
2. 验证 IP 地址：`http://192.168.126.132:8080`
...
- **沙箱健康检查**：`curl http://192.168.126.132:8080/v1/sandbox`
- **沙箱信息获取**：`curl http://192.168.126.132:8080/v1/sandbox`
- **沙箱浏览器信息**：`curl http://192.168.126.132:8080/v1/browser/info`
...
- **IP 地址迁移**：从 192.168.96.135 迁移到 192.168.126.132
...
| **SANDBOX_LOCAL_URL** | **字符串** | **否** | **http://192.168.126.132:8080** | **本地沙箱地址** |
